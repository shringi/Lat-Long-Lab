...
export class Logger {
  ...
  static initUI() {
    ...
    if (closeBtn)
      closeBtn.addEventListener("click", () => Logger.toggleConsole(false));
    if (showDebugBtn)
      showDebugBtn.addEventListener("click", () => Logger.toggleConsole(true));
    ...
    console.error = function (...args) {
      ...
      if (args.length > 0) {
        ...
        if (
          ...
          firstArg.message &&
          firstArg.message.includes("ResizeObserver loop")
        )
          return;
      }
